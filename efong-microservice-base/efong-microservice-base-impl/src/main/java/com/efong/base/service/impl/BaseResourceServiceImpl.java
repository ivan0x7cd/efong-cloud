...
import com.efong.base.config.BaseThreadPool;
import com.efong.base.domain.basic.BaseResource;
import com.efong.base.mapper.basic.BaseResourceMapper;
import com.efong.base.mapper.extend.BaseResourceExtendMapper;
...
import com.efong.base.vm.BaseUserVM;
...
public class BaseResourceServiceImpl implements BaseResourceService {
    ...
    public List<BaseResourceVM> indexResource() {
        ...
        //先到缓存拿数据
        RMapCache<String, Map<String,List<BaseResourceVM>>> resourceMapCache = redissonClient.getMapCache(MicroserviceBaseConstants.REDIS_RESOURCE_TREE);
