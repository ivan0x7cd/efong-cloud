...
import com.efong.base.mapper.basic.BaseRoleMapper;
import com.efong.base.mapper.extend.BaseRoleExtendMapper;
import com.efong.base.service.BaseRoleService;
...
public class BaseRoleServiceImpl implements BaseRoleService {
    ...
    public void saveRole(BaseRoleCreateVM role) {
        ...
        baseRole.setType(MicroserviceBaseConstants.RoleType.CUSTOMIZE.getValue());
        baseRole.setStatus(MicroserviceBaseConstants.RoleStatus.NORMAL.getValue());
    ...
    public PageInfo<BaseRoleListVM> roleList(BaseRoleSearchVM search) {
        ...
        List<BaseRoleListVM> collect = baseRoleList.stream()
                .parallel()
                .filter(r -> r.getStatus().equals(MicroserviceBaseConstants.RoleStatus.NORMAL.getValue()))
